...
public class Q4_pair {
    ...
    public static void main(String[] args){                 //O(nlogn)
        ...
        //we can simply skip this if we just want to length but don't want to know the pair.
        for(int i=0;i<pair.length;i++){
            //pair.length for totalNo of rows and pair[0].length for coloum
            pair[i][0]=i;
            pair[i][1]=arr[i][0];
            pair[i][2]=arr[i][1];
        }

...
public class Q2_knapsack {
    /*given the weight and values of n items,put these in a knapsack(bag or something) of capacity w to get max
    value in tha knapsack*/
    public static void main(String[] args) {
        ...
        //it's sorted in ascending order, but we need tha max ratio first ie weight is min and value is high

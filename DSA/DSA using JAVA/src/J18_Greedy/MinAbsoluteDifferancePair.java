...
public class MinAbsoluteDifferancePair {
    ...
    public static void main(String[] args){
        ...
        /* we will get min difference only when we select min value from 1st array and min value
         from 2nd array for a pair coz the difference will be min if we minus min value to min value
         and minus max value to max value */
        Arrays.sort(a);
        Arrays.sort(b);
        int sum=0;

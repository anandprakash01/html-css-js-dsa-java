package J12_LinkedList.LoopLL;

public class CircularLL {
//    linked-list is forming a full loop starting from head
//    ----------------------Node class-------------------
    static class Node{
        int data;
        Node next;
    ...
    void insertAtBeginning(int data){
        ...
        while(temp.next!=head){
            temp=temp.next; //if there is only 1 Node then it will come back to head;
        }

...
public class Q6_lowestCommonAncestor {
    static class Node{
        int data;
        Node left;
        Node right;
    ...
    public static Node lca(Node root,int n1,int n2){// O(n) and space complexity O(n)
    ...
    //Approch 2 for Lowest common Ancestor  TC O(n) and Space O(1)
